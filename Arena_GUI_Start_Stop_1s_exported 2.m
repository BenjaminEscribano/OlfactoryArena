classdef Arena_GUI_Start_Stop_1s_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function StartButton_2Pushed(app, event)
            ...
            LEDKnobValues(app);
            app.int=app.KnobValues{1}/100*2.5;
            writePWMVoltage(app.a, app.LEDKnobOutPutChannel{1},0);
            pause(1);
            writePWMVoltage(app.a, app.LEDKnobOutPutChannel{1},app.int);            
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Arena_GUI_Start_Stop_1s_exported
